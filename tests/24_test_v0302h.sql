/*
sp_HeapDoctor Test Harness - v2026.03.11.1: Batch H output features
...
RAISERROR(N'=== Batch 24: v2026.03.11.1 (#16, #23) ===', 10, 1) WITH NOWAIT;
...
IF @ver24 = N'2026.03.11.1'
    RAISERROR(N'  PASS 24V: Version is 2026.03.11.1.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 24V: Version is %s (expected 2026.03.11.1).', 10, 1, @ver24) WITH NOWAIT;
GO
...
RAISERROR(N'Batch 24 tests complete. Review PASS/FAIL results above.', 10, 1) WITH NOWAIT;
GO
