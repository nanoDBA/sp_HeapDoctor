/*
sp_HeapDoctor Test Harness - v2026.07.30.1: Batch A+C features
...
RAISERROR(N'=== Batch 19: v2026.07.30.1 (#68, #18, #75, #78, #63, #89) ===', 10, 1) WITH NOWAIT;
...
IF @ver19 = N'2026.07.30.1'
    RAISERROR(N'  PASS 19V: Version is 2026.07.30.1.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 19V: Version is %s (expected 2026.07.30.1).', 10, 1, @ver19) WITH NOWAIT;
GO
