...
IF @ver19 = N'1.0.2026.0302i'
    RAISERROR(N'  PASS 19V: Version is 1.0.2026.0302i.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 19V: Version is %s (expected 1.0.2026.0302i).', 10, 1, @ver19) WITH NOWAIT;
GO
