/*
sp_HeapDoctor Test Harness - Batch G discovery
...
Tests:
  ...
  -- Version --
  23V - Version matches dbo.ExpectedVersion
...
RAISERROR(N'=== Batch 23: (#22, #88) ===', 10, 1) WITH NOWAIT;
...
IF @ver23 = (SELECT version FROM dbo.ExpectedVersion)
    RAISERROR(N'  PASS 23V: Version matches dbo.ExpectedVersion.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 23V: Version is %s and does not match dbo.ExpectedVersion.', 10, 1, @ver23) WITH NOWAIT;
GO
