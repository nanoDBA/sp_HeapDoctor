/*
sp_HeapDoctor Test Harness - v2026.07.31.2: Batch G discovery
...
RAISERROR(N'=== Batch 23: v2026.07.31.2 (#22, #88) ===', 10, 1) WITH NOWAIT;
...
IF @ver23 = N'2026.07.31.2'
    RAISERROR(N'  PASS 23V: Version is 2026.07.31.2.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 23V: Version is %s (expected 2026.07.31.2).', 10, 1, @ver23) WITH NOWAIT;
GO
