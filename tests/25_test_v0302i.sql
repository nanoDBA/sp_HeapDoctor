...
IF @ver25 = N'1.0.2026.0302i'
    RAISERROR(N'  PASS 25V: Version is 1.0.2026.0302i.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 25V: Version is %s (expected 1.0.2026.0302i).', 10, 1, @ver25) WITH NOWAIT;
GO
