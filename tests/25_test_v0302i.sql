/*
sp_HeapDoctor Test Harness - v2026.07.31.4: Batch I resumable + temporal
...
RAISERROR(N'=== Batch 25: v2026.07.31.4 (#85, #84) ===', 10, 1) WITH NOWAIT;
...
IF @ver25 = N'2026.07.31.4'
    RAISERROR(N'  PASS 25V: Version is 2026.07.31.4.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 25V: Version is %s (expected 2026.07.31.4).', 10, 1, @ver25) WITH NOWAIT;
GO
