/*
sp_HeapDoctor Test Harness - Batch I resumable + temporal
...
Tests:
  ...
  -- Version --
  25V - Version matches dbo.ExpectedVersion
...
RAISERROR(N'=== Batch 25: (#85, #84) ===', 10, 1) WITH NOWAIT;
...
IF @ver25 = (SELECT version FROM dbo.ExpectedVersion)
    RAISERROR(N'  PASS 25V: Version matches dbo.ExpectedVersion.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 25V: Version is %s and does not match dbo.ExpectedVersion.', 10, 1, @ver25) WITH NOWAIT;
GO
