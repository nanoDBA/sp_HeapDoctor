/*
sp_HeapDoctor Test Harness - v2026.07.31.1: Advisory warnings + @LockTimeoutMs docs
...
RAISERROR(N'=== Batch 30: v2026.07.31.1 (#179, #182, #181) ===', 10, 1) WITH NOWAIT;
...
IF @ver30 = N'2026.07.31.1'
    RAISERROR(N'  PASS 30V: Version is 2026.07.31.1.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 30V: Version is %s (expected 2026.07.31.1).', 10, 1, @ver30) WITH NOWAIT;
GO
/*#endregion*/
