...
IF @12a_version = N'1.0.2026.0302e'
    RAISERROR(N'  PASS 12A: Version is 1.0.2026.0302e.', 10, 1) WITH NOWAIT;
ELSE
BEGIN
    DECLARE @12a_msg nvarchar(200) = N'  *** FAIL 12A: Expected version 1.0.2026.0302e, got ' + ISNULL(@12a_version, N'NULL');
