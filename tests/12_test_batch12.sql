...
IF @12a_version = N'2026.07.30.1'
    RAISERROR(N'  PASS 12A: Version is 2026.07.30.1.', 10, 1) WITH NOWAIT;
ELSE
BEGIN
    DECLARE @12a_msg nvarchar(200) = N'  *** FAIL 12A: Expected version 2026.07.30.1, got ' + ISNULL(@12a_version, N'NULL');
