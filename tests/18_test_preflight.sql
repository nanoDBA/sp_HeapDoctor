...
IF @ver18 = N'1.0.2026.0302g'
    RAISERROR(N'  PASS 18V: Version is 1.0.2026.0302g.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 18V: Version is %s (expected 1.0.2026.0302g).', 10, 1, @ver18) WITH NOWAIT;
GO
