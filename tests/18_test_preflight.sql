...
IF @ver18 = N'1.0.2026.0302c'
    RAISERROR(N'  PASS 18V: Version is 1.0.2026.0302c.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 18V: Version is %s (expected 1.0.2026.0302c).', 10, 1, @ver18) WITH NOWAIT;
GO
