...
IF @ver18 = N'2026.03.11.1'
    RAISERROR(N'  PASS 18V: Version is 2026.03.11.1.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 18V: Version is %s (expected 2026.03.11.1).', 10, 1, @ver18) WITH NOWAIT;
GO
