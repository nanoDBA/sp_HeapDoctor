/*
sp_HeapDoctor Test Harness - v2026.07.30.1: Batch E statistics
...
RAISERROR(N'=== Batch 21: v2026.07.30.1 (#19, #91) ===', 10, 1) WITH NOWAIT;
...
IF @ver21 = N'2026.07.30.1'
    RAISERROR(N'  PASS 21V: Version is 2026.07.30.1.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 21V: Version is %s (expected 2026.07.30.1).', 10, 1, @ver21) WITH NOWAIT;
GO
