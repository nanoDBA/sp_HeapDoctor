/*
sp_HeapDoctor Test Harness - Batch E statistics
...
Tests:
  ...
  -- Version --
  21V - Version matches dbo.ExpectedVersion
...
RAISERROR(N'=== Batch 21: (#19, #91) ===', 10, 1) WITH NOWAIT;
...
IF @ver21 = (SELECT version FROM dbo.ExpectedVersion)
    RAISERROR(N'  PASS 21V: Version matches dbo.ExpectedVersion.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 21V: Version is %s and does not match dbo.ExpectedVersion.', 10, 1, @ver21) WITH NOWAIT;
GO
