/*
sp_HeapDoctor Test Harness - v1.0.2026.0302i: Batch E statistics
...
IF @ver21 = N'1.0.2026.0302i'
    RAISERROR(N'  PASS 21V: Version is 1.0.2026.0302i.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 21V: Version is %s (expected 1.0.2026.0302i).', 10, 1, @ver21) WITH NOWAIT;
GO
