/*
sp_HeapDoctor Test Harness - Post-rebuild row count validation (#188)
...
Tests:
  ...
  -- Version --
  32V - Version matches dbo.ExpectedVersion
...
RAISERROR(N'=== Batch 32: (#188 row count validation) ===', 10, 1) WITH NOWAIT;
...
IF @ver32 = (SELECT version FROM dbo.ExpectedVersion)
    RAISERROR(N'  PASS 32V: Version matches dbo.ExpectedVersion.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 32V: Version is %s and does not match dbo.ExpectedVersion.', 10, 1, @ver32) WITH NOWAIT;
GO
/*#endregion*/
...
RAISERROR(N'=== Batch 32 tests complete. Review results above. ===', 10, 1) WITH NOWAIT;
GO
/*#endregion*/
