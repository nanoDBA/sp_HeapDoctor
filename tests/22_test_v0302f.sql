/*
sp_HeapDoctor Test Harness - v2026.07.31.3: Batch F observability
...
IF @ver22 = N'2026.07.31.3'
    RAISERROR(N'  PASS 22V: Version is 2026.07.31.3.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 22V: Version is %s (expected 2026.07.31.3).', 10, 1, @ver22) WITH NOWAIT;
GO
