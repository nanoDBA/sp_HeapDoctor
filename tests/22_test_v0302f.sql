...
IF @ver22 = N'1.0.2026.0302i'
    RAISERROR(N'  PASS 22V: Version is 1.0.2026.0302i.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 22V: Version is %s (expected 1.0.2026.0302i).', 10, 1, @ver22) WITH NOWAIT;
GO
