/*
sp_HeapDoctor Test Harness - QUICKIESTORE DDL builder (#194)
...
Tests:
  ...
  -- Version --
  33V - Version matches dbo.ExpectedVersion
...
RAISERROR(N'=== Batch 33: (#194 QUICKIESTORE DDL builder) ===', 10, 1) WITH NOWAIT;
...
IF @ver33 LIKE N'%' + (SELECT version FROM dbo.ExpectedVersion) + N'%'
    RAISERROR(N'  PASS 33V: Version matches dbo.ExpectedVersion.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 33V: Version is %s and does not match dbo.ExpectedVersion.', 10, 1, @ver33) WITH NOWAIT;
GO
/*#endregion*/
