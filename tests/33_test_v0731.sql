/*
sp_HeapDoctor Test Harness - v2026.07.31.2: QUICKIESTORE DDL builder (#194)
...
RAISERROR(N'=== Batch 33: v2026.07.31.2 (#194 QUICKIESTORE DDL builder) ===', 10, 1) WITH NOWAIT;
...
IF @ver33 LIKE N'%2026.07.31.2%'
    RAISERROR(N'  PASS 33V: Version is 2026.07.31.2.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 33V: Version is %s (expected 2026.07.31.2).', 10, 1, @ver33) WITH NOWAIT;
GO
/*#endregion*/
