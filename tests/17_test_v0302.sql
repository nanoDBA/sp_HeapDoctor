...
IF @ver17 = N'1.0.2026.0302i'
    RAISERROR(N'  PASS 17V: Version is 1.0.2026.0302i.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 17V: Version is %s (expected 1.0.2026.0302i).', 10, 1, @ver17) WITH NOWAIT;
GO
