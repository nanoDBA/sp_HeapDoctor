/*
sp_HeapDoctor Test Harness - v2026.07.31.1: #25 @Force, #33 LOB TOCTOU, #71 CommandLog schema
...
RAISERROR(N'=== Batch 17: v2026.07.31.1 (#25 @Force, #33 LOB TOCTOU, #71 CommandLog schema) ===', 10, 1) WITH NOWAIT;
...
IF @ver17 = N'2026.07.31.1'
    RAISERROR(N'  PASS 17V: Version is 2026.07.31.1.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 17V: Version is %s (expected 2026.07.31.1).', 10, 1, @ver17) WITH NOWAIT;
GO
