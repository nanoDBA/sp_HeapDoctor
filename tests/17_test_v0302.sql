/*
sp_HeapDoctor Test Harness - #25 @Force, #33 LOB TOCTOU, #71 CommandLog schema
...
Tests:
  ...
  -- Version --
  17V - Version matches dbo.ExpectedVersion
...
RAISERROR(N'=== Batch 17: (#25 @Force, #33 LOB TOCTOU, #71 CommandLog schema) ===', 10, 1) WITH NOWAIT;
...
IF @ver17 = (SELECT version FROM dbo.ExpectedVersion)
    RAISERROR(N'  PASS 17V: Version matches dbo.ExpectedVersion.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 17V: Version is %s and does not match dbo.ExpectedVersion.', 10, 1, @ver17) WITH NOWAIT;
GO
...
RAISERROR(N'Batch 17 tests complete. Review results above.', 10, 1) WITH NOWAIT;
GO
