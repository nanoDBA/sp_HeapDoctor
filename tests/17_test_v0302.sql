/*
sp_HeapDoctor Test Harness - v1.0.2026.0302e: #25 @Force, #33 LOB TOCTOU, #40 CommandLog schema
...
RAISERROR(N'=== Batch 17: v1.0.2026.0302e (#25 @Force, #33 LOB TOCTOU, #40 CommandLog schema) ===', 10, 1) WITH NOWAIT;
...
IF @ver17 = N'1.0.2026.0302e'
    RAISERROR(N'  PASS 17V: Version is 1.0.2026.0302e.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 17V: Version is %s (expected 1.0.2026.0302e).', 10, 1, @ver17) WITH NOWAIT;
GO
