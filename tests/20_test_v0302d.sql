/*
sp_HeapDoctor Test Harness - v2026.07.30.1: Batch D quick wins
...
RAISERROR(N'=== Batch 20: v2026.07.30.1 (#24, #77, #70, #21) ===', 10, 1) WITH NOWAIT;
...
IF @ver20 = N'2026.07.30.1'
    RAISERROR(N'  PASS 20V: Version is 2026.07.30.1.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 20V: Version is %s (expected 2026.07.30.1).', 10, 1, @ver20) WITH NOWAIT;
GO
