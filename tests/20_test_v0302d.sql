/*
sp_HeapDoctor Test Harness - v1.0.2026.0302g: Batch D quick wins
...
RAISERROR(N'=== Batch 20: v1.0.2026.0302g (#24, #47, #39, #21) ===', 10, 1) WITH NOWAIT;
...
IF @ver20 = N'1.0.2026.0302g'
    RAISERROR(N'  PASS 20V: Version is 1.0.2026.0302g.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 20V: Version is %s (expected 1.0.2026.0302g).', 10, 1, @ver20) WITH NOWAIT;
GO
