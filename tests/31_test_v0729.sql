/*
sp_HeapDoctor Test Harness - v2026.07.31.2: Remove causal filtered-statistics warning (#186)
...
RAISERROR(N'=== Batch 31: v2026.07.31.2 (#186 filtered-statistics warning removal) ===', 10, 1) WITH NOWAIT;
...
IF @ver31 = N'2026.07.31.2'
    RAISERROR(N'  PASS 31V: Version is 2026.07.31.2.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 31V: Version is %s (expected 2026.07.31.2).', 10, 1, @ver31) WITH NOWAIT;
GO
/*#endregion*/
