/*
sp_HeapDoctor Test Harness - Remove causal filtered-statistics warning (#186)
...
Tests:
  ...
  -- Version --
  31V - Version matches dbo.ExpectedVersion
...
RAISERROR(N'=== Batch 31: (#186 filtered-statistics warning removal) ===', 10, 1) WITH NOWAIT;
...
IF @ver31 = (SELECT version FROM dbo.ExpectedVersion)
    RAISERROR(N'  PASS 31V: Version matches dbo.ExpectedVersion.', 10, 1) WITH NOWAIT;
ELSE
    RAISERROR(N'  FAIL 31V: Version is %s and does not match dbo.ExpectedVersion.', 10, 1, @ver31) WITH NOWAIT;
GO
/*#endregion*/
...
RAISERROR(N'=== Batch 31 tests complete. Review results above. ===', 10, 1) WITH NOWAIT;
GO
/*#endregion*/
